...
<img width="1593" height="958" alt="image" src="https://github.com/user-attachments/assets/edfb079c-a164-466a-b3bc-4dd975e67406" />
...
<img width="2048" height="1902" alt="image" src="https://github.com/user-attachments/assets/d6532820-6e23-4bdf-81ab-9b733732bf5f" />
...
<img width="2821" height="2363" alt="image" src="https://github.com/user-attachments/assets/041dba42-6650-4de1-8828-eba42ae7d465" />

<!-- TODO: Thêm ảnh so sánh mô hình (file: ai_controller/data/plots/model_comparison.png) -->
<img width="4164" height="1469" alt="image" src="https://github.com/user-attachments/assets/02155919-66f7-4dc4-afec-6a37bfe07b45" />
...
<img width="98" height="96" alt="image" src="https://github.com/user-attachments/assets/cbfde57b-d724-4932-b67c-a78a02758a91" />
...
|------|-----|------|-----------|------|-----------|-------------------|
|![Fire_Handsign_Fixed](https://github.com/user-attachments/assets/f5beb207-08b4-4806-aceb-0c7cc121eb5f)| **Fire** | Đơn mục tiêu | 15 | 10 | Đốt cháy (5 dmg/3s) | Mặc định |
|![Water_Handsign_Fixed](https://github.com/user-attachments/assets/f29cc9b1-cdd8-4ea0-9a2f-29d4c6d07f66)| **Water** | Diện rộng | 10 | 12 | Hất tung (1s) | Mặc định |
|![Earth_Handsign_Fixed](https://github.com/user-attachments/assets/d97d5e3b-94e6-42bb-a294-f33f9d874c18)| **Earth** | Đơn mục tiêu | 20 | 10 | Choáng (1s) | Mặc định |
|![Air_Handsign_Fixed](https://github.com/user-attachments/assets/ef1e4592-1a03-4adf-af38-24c4f24753c2)| **Air** | Diện rộng | 8 | 10 | Đẩy lùi (lực 150) | Mặc định |
|![Lightning_Handsign_Fixed](https://github.com/user-attachments/assets/9a66cbc2-eee7-425d-9e38-6dc1e419ee56)| **Lightning** | Đơn mục tiêu | 25 | 15 | Dây chuyền (0.5s delay) | Mặc định |
|![Ice_Handsign_Fixed](https://github.com/user-attachments/assets/d3102c1f-ae71-4bd8-896c-662c13dee78b)| **Ice** | Đơn mục tiêu | 12 | 12 | Làm chậm (0.5x, 3s) + Đóng băng (1s) | Mặc định |
|![Dark_Handsign_Fixed](https://github.com/user-attachments/assets/1c79a1ce-cdbd-4b3f-a606-add7d17ff6c9)| **Dark** | Đơn mục tiêu | 10 | 15 | Nguyền rủa (4 dmg/5s, lây lan) | Mặc định |
|![Light_Handsign_Fixed](https://github.com/user-attachments/assets/a66f77af-e15a-46e0-bebe-9ff92396c2eb)| **Light** | Diện rộng | 18 | 14 | Đánh kép (1s delay) | Mặc định |
|![Crystal_Handsign_Fixed](https://github.com/user-attachments/assets/cf514700-cd2c-4319-a2dc-59ad071f9a68)| **Crystal** | Diện rộng | 30 | 20 | — | Tiêu diệt 10 quái |
|![Phoenix_Hands_Fixedign](https://github.com/user-attachments/assets/23ee97aa-3f6f-4290-81b8-950b3da4a284)| **Phoenix** | Diện rộng | 35 | 25 | Nổ trễ | Tiêu diệt 10 quái |
...
|--------|-----|-----|-----------|--------|----------|-------------------|-----|
| <!-- TODO: slime sprite --> <img width="98" height="96" alt="image" src="https://github.com/user-attachments/assets/487268e6-9ac0-434c-a4d6-1aa83be139ef" />| **Slime** | 15 | 5 | 35 | 1000 | 0.6s | 25 |
| <!-- TODO: skeleton sprite --> <img width="98" height="100" alt="image" src="https://github.com/user-attachments/assets/566854f4-b112-4600-a933-570bba65065d" />| **Skeleton** | 20 | 8 | 70 | 1200 | 0.8s | 40 |
| <!-- TODO: orc sprite --> <img width="98" height="96" alt="image" src="https://github.com/user-attachments/assets/2ce013d8-0d88-445f-9cae-7eedb02ce37d" />| **Orc** | 30 | 10 | 60 | 1500 | 1.0s | 50 |
| <!-- TODO: werewolf sprite --> <img width="98" height="94" alt="image" src="https://github.com/user-attachments/assets/a5927983-d23e-46c0-9d1d-0fe3fd87b5dc" />| **Werewolf** | 35 | 12 | 70 | 1800 | 0.6s | 120 |
| <!-- TODO: armored_skeleton sprite --> <img width="98" height="100" alt="image" src="https://github.com/user-attachments/assets/480533e2-ea87-4267-bb72-a528caa1f87e" />| **Armored Skeleton** | 40 | 10 | 50 | 1200 | 1.0s | 70 |
| <!-- TODO: armored_orc sprite --> <img width="98" height="94" alt="image" src="https://github.com/user-attachments/assets/36480247-b5e4-46d3-ad72-734918414a03" />| **Armored Orc** | 60 | 12 | 45 | 1500 | 1.2s | 100 |
| <!-- TODO: greatsword_skeleton sprite --> <img width="98" height="94" alt="image" src="https://github.com/user-attachments/assets/f8a0893e-7371-4ece-a84e-c896a234c11f" />| **Greatsword Skeleton** | 35 | 25 | 40 | 1500 | 2.0s | 90 |
| <!-- TODO: orc_rider sprite --> <img width="98" height="98" alt="image" src="https://github.com/user-attachments/assets/76bd2ec0-3640-4acc-9103-b0997b5917cd" />| **Orc Rider** | 70 | 15 | 80 | 2000 | 1.0s | 130 |
| <!-- TODO: elite_orc sprite --> <img width="98" height="100" alt="image" src="https://github.com/user-attachments/assets/07cdbecc-ecb1-4c96-8bf1-b3d80ecfdd12" />| **Elite Orc** | 80 | 20 | 50 | 1500 | 1.0s | 150 |
| <!-- TODO: werebear sprite --> <img width="98" height="98" alt="image" src="https://github.com/user-attachments/assets/8138af22-88a5-43c9-85da-0a60a2909149" />| **Werebear** | 100 | 18 | 35 | 1500 | 1.5s | 200 |
...
<img width="1596" height="955" alt="image" src="https://github.com/user-attachments/assets/184ec103-7733-4890-91c3-847f7ca57801" />
